describe("Traversing DOM elements in Cypress", () => {
  beforeEach(() => {
    ...
    it("first() to retrieve the first DOM element within elements ", () => {
      cy.get('.table-light').find('td').first().should('contain', "Andy");
    });
  
    it("last() to retrieve the last DOM element within elements", () => {
      cy.get('.table-light').find('td').last().should('contain', "Scott");
    });
    ...
    it("parents() to get parents DOM element of elements", () => {
      // cy.get('.traversal-cite').parents('blockquote').should('be.visible');
    ...
    it("siblings() To get all sibling DOM elements of elements", () => {
      //Using ">"" looks only to child elements, using onl " " between selectors will look too grandchildren element as well
